        ...
        <main className="flex-grow pt-24">
              ...
              <div className="flex flex-col lg:flex-row items-center">
                <div className="lg:w-1/2 mb-8 lg:mb-0">
                  ...
                  <p className="text-gray-600 mb-6 md:text-lg">
                    Streamline your benefits management with our advanced
                    platform designed to simplify administration, reduce costs,
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 max-w-3xl mx-auto">
                  Our benefits administration module provides a complete
                  solution for managing all aspects of your employee benefits
                  programs.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Manage medical, dental, and vision plans with automated enrollment and eligibility tracking.",
                  },
                  {
                    icon: <Award className="h-8 w-8 text-green-600" />,
                    title: "Retirement Plans",
                    description:
                      "Administer 401(k), pension, and other retirement benefits with compliance support.",
                  },
                  {
                    icon: <Heart className="h-8 w-8 text-green-600" />,
                    title: "Wellness Programs",
                    description:
                      "Create and manage wellness initiatives to improve employee health and reduce healthcare costs.",
                  },
                  {
                    icon: <Activity className="h-8 w-8 text-green-600" />,
                    title: "Life & Disability",
                    description:
                      "Streamline life insurance and disability benefits administration with simplified claims processing.",
                  },
                  {
                    icon: <Gift className="h-8 w-8 text-green-600" />,
                    title: "Voluntary Benefits",
                    description:
                      "Offer and manage supplemental benefits that enhance your total compensation package.",
                  },
                  {
                    icon: <Users className="h-8 w-8 text-green-600" />,
                    title: "Family Benefits",
                    description:
                      "Administer parental leave, childcare assistance, and other family-friendly benefits.",
                  },
                ].map((feature, index) => (
                  <Card
                    key={index}
              ...
              <div className="flex flex-col lg:flex-row items-center">
                ...
                <div className="lg:w-1/2">
                  ...
                  <p className="text-gray-600 mb-6">
                    Empower your employees with our intuitive self-service
                    portal that makes it easy to:
                  </p>
          ...
          <section className="py-16 bg-gradient-to-r from-green-600 to-green-700 text-white">
            <div className="container mx-auto px-4 text-center">
              <h2 className="text-3xl font-bold mb-4">
                Ready to Transform Your Benefits Administration?
              </h2>
              <p className="mb-8 max-w-2xl mx-auto">
                Join thousands of companies that have streamlined their benefits
                management with Vertex HCM's comprehensive solution.
              </p>
