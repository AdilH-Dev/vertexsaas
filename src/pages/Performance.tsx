            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pl-8">
                ...
                <p className="text-lg text-gray-700 mb-8">
                  Set goals, track progress, and provide meaningful feedback to
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Set clear objectives and key results at individual, team, and
                  organizational levels. Track progress in real-time and ensure
              ...
              <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Conduct comprehensive performance evaluations with
                  customizable review cycles. Support for 360-degree feedback,
              ...
              <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Promote a culture of ongoing feedback with tools for
                  recognition, constructive feedback, and coaching. Capture
              ...
              <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Gain valuable insights with performance analytics. Identify
                  high performers, performance gaps, and training needs with
