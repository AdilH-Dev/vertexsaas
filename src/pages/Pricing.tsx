...
const PricingCard = ({ 
  ...
  return (
    <div className={`relative rounded-2xl p-8 shadow-lg transition-all duration-300 hover:shadow-xl flex flex-col h-full ${
      isPopular ? 'bg-gradient-to-br from-vertex-blue-light to-vertex-blue text-white' : 'bg-white'
    }`}>
      {isPopular && (
      ...
      <p className={`mb-6 text-sm ${isPopular ? 'text-white/90' : 'text-gray-500'}`}>
        {description}
      </p>
  ...
  const pricingPlans = [
    {
      title: "Starter",
      price: "$199",
      description: "Perfect for startups and small businesses just beginning with HCM.",
      features: [
        "Core HR Management",
        ...
        <section className="py-16 bg-gradient-to-br from-gray-50 to-gray-100">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Choose the perfect plan for your organization's needs with no hidden fees.
            </p>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
              ...
              {[
                {
                  ...
                  answer: "Yes, we offer a 14-day free trial on all our plans with full access to all features. No credit card required."
                },
                {
                ...
                },
                {
                  ...
                  answer: "Your data is encrypted at rest and in transit. We employ industry-standard security measures and are SOC 2 and GDPR compliant."
                }
              ].map((faq, index) => (
            ...
            <div className="mt-12 text-center">
              ...
              <p className="text-gray-600 mb-6">Our team is ready to help you find the perfect solution for your organization.</p>
