            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                ...
                <p className="text-lg text-gray-700 mb-8">
                  Find, assess, and hire the right talent efficiently with our
                  end-to-end recruitment module.
                </p>
            ...
            <Tabs defaultValue="sourcing" className="w-full max-w-4xl mx-auto">
              ...
              <TabsContent value="sourcing" className="rounded-md border p-6">
                ...
                <p className="mb-4 text-gray-700">
                  Find the right talent through multiple channels and build a
              ...
              <TabsContent value="screening" className="rounded-md border p-6">
                ...
                <p className="mb-4 text-gray-700">
                  Efficiently filter candidates with automated screening tools
                  and assessments.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
              ...
              >
                ...
                <p className="mb-4 text-gray-700">
                  Streamline the interview process with scheduling tools and
              ...
              <TabsContent value="onboarding" className="rounded-md border p-6">
                ...
                <p className="mb-4 text-gray-700">
                  Create a seamless transition from candidate to employee with
                  digital onboarding.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
